  ...
  const authHandler = async () => {
    try {
        ...
        await new Promise((resolve) => {
          Alert.alert("Login Successful","You have successfully logged into Cyklofit.", [{ text: 'OK', onPress: resolve }])
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.background }}>
      ...
      >
        ...
        <Text style={{ ...FONTS.h5, color: COLORS.white, marginLeft:100 }}>Login</Text>
       </View>
